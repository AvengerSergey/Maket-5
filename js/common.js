$(document).ready(function() {
    ...
    $(".form").validate({
       ...
       messages:{
            ...
            email:{
             ...
             file:{
                required: "* выберите ваше резюме",
                accept: "* выберите корректный тип файла",
            },
       }
    });
    ...
    $("#btn-1-vac").click(function(){
        
        $(".vacancy").attr("style", "display:none;");
        $("#vacancy-first").fadeIn();
        
    });
    $("#btn-2-vac").click(function(){
        
        $(".vacancy").attr("style", "display:none;");
        $("#vacancy-second").fadeIn();
        
    });
    $("#btn-3-vac").click(function(){
        
        $(".vacancy").attr("style", "display:none;");
        $("#vacancy-third").fadeIn();
        
    });
    $("#btn-4-vac").click(function(){
        
        $(".vacancy").attr("style", "display:none;");
        $("#vacancy-fourth").fadeIn();
